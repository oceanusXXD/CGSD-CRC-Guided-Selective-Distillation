...
class CodebaseCleanlinessTest(unittest.TestCase):
    ...
    def test_scripts_directory_only_contains_public_entrypoints(self) -> None:
        expected = {
            ...
            "build_binary_single_seed_gate_report.py",
            "build_multiclass_training_rows.py",
            ...
            "prepare_binary_benchmark_protocol.py",
            "prepare_query_binary_benchmark.py",
            "prepare_preference_dcms_inputs.py",
            "prepare_preference_cpu_pilot.py",
            ...
            "score_preference_gradients.py",
            "score_binary_pool.py",
            "prepare_multiclass_splits.py",
            "prepare_mias_features.py",
