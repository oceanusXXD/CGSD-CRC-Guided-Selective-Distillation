...
def chunk_text_for_embedding(text: str, *, target_chars: int=3000, overlap_chars: int=300) -> list[str]:
...
def format_pair_embedding_text(text: str, query: str, *, task_label: str='Query', evidence_label: str='Document', instruction_text: str='') -> str:
