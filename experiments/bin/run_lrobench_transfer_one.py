...
def main():
    ...
    run([sys.executable,'scripts/cgsd_predict.py','--output_dir',str(out),'--round_index','1','--model_path',model,'--data_path',str(input_dir/'data.jsonl'),'--split_ids_path',str(out/'cgsd_split_ids.json'),'--checkpoint_dir',str(out/'round_1/model'),'--cache_policy','reuse'])
